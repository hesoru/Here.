...
public class Registry implements Writable {
    ...
    public Registry(String name) {
        ...
        EventLog.getInstance().logEvent(new Event("Registry created: " + this.name));
    }
    ...
    public String removeCaregiver(String caregiverFullName, String confirmChoice) {
...

        {
            ...
            if (childFound != null) {
                EventLog.getInstance().logEvent(new Event(caregiver.getFullName()
                        + " is the primary caregiver listed for " + childFound.getFullName() + ". Remove "
                        + childFound.getFullName() + " before removing " + caregiver.getFullName()
                        + " from the caregiver registry."));
                return childFound.getFullName();
            }
        }
        ...
        if (confirmChoice.equals("yes")) {
            ...
            EventLog.getInstance().logEvent(new Event(caregiver.getFullName()
                    + " removed from caregiver registry."));
